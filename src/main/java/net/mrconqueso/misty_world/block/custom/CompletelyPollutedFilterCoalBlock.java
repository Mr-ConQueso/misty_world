...
public class CompletelyPollutedFilterCoalBlock extends FilterCoalBlock{
    public CompletelyPollutedFilterCoalBlock(Properties pProperties, PollutionState pollutionState) {
