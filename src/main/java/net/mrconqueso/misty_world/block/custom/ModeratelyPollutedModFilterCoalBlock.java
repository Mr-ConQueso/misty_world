...
public class ModeratelyPollutedModFilterCoalBlock extends ModFilterCoalBlock {
    public ModeratelyPollutedModFilterCoalBlock(Properties pProperties, PollutionState pollutionState) {
