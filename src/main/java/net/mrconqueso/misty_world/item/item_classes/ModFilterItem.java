...
public class ModFilterItem extends Item implements IFilter {
    private final float filteringDepth;

    public ModFilterItem(float filteringDepth, Properties properties) {
        super(properties);
    ...
    public void setDamage(ItemStack stack, int damage) {
        stack = ModFilterItem.setDamageNBT(stack, true);
