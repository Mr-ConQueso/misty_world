...
public class FoggyStoneFurnaceMenu extends AbstractContainerMenu {
    public final FoggyStoneFurnaceBlockEntity blockEntity;
    ...
    public FoggyStoneFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FOGGY_STONE_FURNACE_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((FoggyStoneFurnaceBlockEntity) entity);
    ...
    //region Shift Click Items in and out of the container
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FOGGY_STONE_FURNACE.get());
    }
