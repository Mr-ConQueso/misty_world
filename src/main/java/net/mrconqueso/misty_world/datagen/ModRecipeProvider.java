...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        oreBlasting(consumer, SALT_SMELTABLES, RecipeCategory.MISC, ModItems.SALT_FOOD.get(), 0.25f, 100, "salt");
        oreSmelting(consumer, SALT_SMELTABLES, RecipeCategory.MISC, ModItems.SALT_FOOD.get(), 0.25f, 200, "salt");
    }
