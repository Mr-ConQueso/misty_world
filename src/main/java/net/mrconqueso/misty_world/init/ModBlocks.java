...
import net.mrconqueso.misty_world.block.block_classes.*;
import net.mrconqueso.misty_world.block.custom.CampfireBlock;
...
public class    ModBlocks {
    ...
    public static final RegistryObject<Block> FOGGY_STONE = registerBlock("foggy_stone",
            () -> new FoggyStoneBlock(BlockBehaviour.Properties.copy(Blocks.STONE).strength(100.0F).explosionResistance(1000)));
    public static final RegistryObject<Block> MOSSY_FOGGY_STONE = registerBlock("mossy_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE).strength(3.0F).explosionResistance(10)));
    public static final RegistryObject<Block> POROUS_FOGGY_STONE = registerBlock("porous_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).strength(5.0F).explosionResistance(20)));
    public static final RegistryObject<Block> HARD_FOGGY_STONE = registerBlock("hard_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE).strength(800.0F).explosionResistance(8000)));
    public static final RegistryObject<Block> MINED_FOGGY_STONE = registerBlock("mined_foggy_stone",
            () -> new MinedFoggyStoneBlock(BlockBehaviour.Properties.copy(Blocks.STONE).strength(3.0F).explosionResistance(10)));
    public static final RegistryObject<Block> MOSSY_MINED_FOGGY_STONE = registerBlock("mossy_mined_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).strength(3.0F).explosionResistance(10)));
    public static final RegistryObject<Block> FOGGY_COBBLESTONE = registerBlock("foggy_cobblestone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE).strength(3.0F).explosionResistance(10)));
    ...
    public static final RegistryObject<Block> CHISELED_FOGGY_STONE = registerBlock("chiseled_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CHISELED_STONE_BRICKS).strength(3.0F).explosionResistance(10)));
    public static final RegistryObject<Block> MOSSY_CHISELED_FOGGY_STONE = registerBlock("mossy_chiseled_foggy_stone",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CHISELED_STONE_BRICKS).strength(3.0F).explosionResistance(10)));
    ...
    public static final RegistryObject<Block> FOGGY_COBBLESTONE_WALL = registerBlock("foggy_cobblestone_wall",
            () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE_WALL).strength(3.0F).explosionResistance(10)));
    ...
    public static final RegistryObject<Block> WET_SAND = registerBlock("wet_sand",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.SAND).strength(0.5F)));
    ...
    public static final RegistryObject<Block> WET_RED_SAND = registerBlock("wet_red_sand",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.RED_SAND).strength(0.5F)));
    ...
    public static final RegistryObject<Block> WET_ACIDIC_SAND = registerBlock("wet_acidic_sand",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.SAND).strength(0.5F).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY)));
    public static final RegistryObject<Block> DRY_ACIDIC_SAND = registerBlock("dry_acidic_sand",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.SAND).strength(0.5F).mapColor(MapColor.TERRACOTTA_YELLOW)));
    public static final RegistryObject<Block> FOGGY_GRAVEL = registerBlock("foggy_gravel",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.GRAVEL).strength(0.6F)));

    // --------- / CLAY / --------- //
    public static final RegistryObject<Block> WET_GRAY_CLAY = registerBlock("wet_gray_clay",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CLAY).strength(1.5F)));
    public static final RegistryObject<Block> DRY_GRAY_CLAY = registerBlock("dry_gray_clay",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CYAN_TERRACOTTA).strength(1.5F)));
    ...
    public static final RegistryObject<Block> WET_RED_CLAY = registerBlock("wet_red_clay",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.CLAY).strength(1.5F).mapColor(MapColor.TERRACOTTA_ORANGE)));
    public static final RegistryObject<Block> DRY_RED_CLAY = registerBlock("dry_red_clay",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.RED_TERRACOTTA).strength(1.5F)));
    ...
    public static final RegistryObject<Block> WET_SAPROPEL = registerBlock("wet_sapropel",
            () -> new FallingBlock(BlockBehaviour.Properties.copy(Blocks.DIRT).strength(0.5F)));
    ...
    public static final RegistryObject<Block> ASPEN_LOG = registerBlock("aspen_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.COLOR_LIGHT_GRAY)));
    public static final RegistryObject<Block> ASPEN_WOOD = registerBlock("aspen_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_LIGHT_GRAY)));
    ...
    public static final RegistryObject<Block> ASPEN_PLANKS = registerBlock("aspen_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).mapColor(MapColor.GLOW_LICHEN)));
    public static final RegistryObject<Block> ASPEN_LEAVES = registerBlock("aspen_leaves",
            () -> new ModLeavesBlock(8, 10, BlockBehaviour.Properties.copy(Blocks.ACACIA_LEAVES)));
    ...
    public static final RegistryObject<Block> ASPEN_BUTTON = registerBlock("aspen_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON).mapColor(MapColor.GLOW_LICHEN),
                    BlockSetType.OAK, 10, true));
    public static final RegistryObject<Block> ASPEN_PRESSURE_PLATE = registerBlock("aspen_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE).mapColor(MapColor.GLOW_LICHEN),
                    BlockSetType.OAK));
    ...
    public static final RegistryObject<Block> ASPEN_FENCE_GATE = registerBlock("aspen_fence_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE).mapColor(MapColor.GLOW_LICHEN),
                    SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));

    public static final RegistryObject<Block> ASPEN_DOOR = registerBlock("aspen_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR).mapColor(MapColor.GLOW_LICHEN),
                    BlockSetType.OAK));
    public static final RegistryObject<Block> ASPEN_TRAPDOOR = registerBlock("aspen_trapdoor",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR ).mapColor(MapColor.GLOW_LICHEN),
                    BlockSetType.OAK));

    // --- / UMBRELLA TREE / --- //
    public static final RegistryObject<Block> UMBRELLA_TREE_LOG = registerBlock("umbrella_tree_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_LOG).mapColor(MapColor.TERRACOTTA_CYAN)));
    public static final RegistryObject<Block> UMBRELLA_TREE_WOOD = registerBlock("umbrella_tree_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_WOOD).mapColor(MapColor.TERRACOTTA_CYAN)));
    ...
    public static final RegistryObject<Block> UMBRELLA_TREE_LEAVES = registerBlock("umbrella_tree_leaves",
            () -> new ModLeavesBlock(1, 3, BlockBehaviour.Properties.copy(Blocks.BIRCH_LEAVES)));
    ...
    public static final RegistryObject<Block> FOREST_DECEIVER_LOG = registerBlock("forest_deceiver_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> FOREST_DECEIVER_WOOD = registerBlock("forest_deceiver_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> STRIPPED_FOREST_DECEIVER_LOG = registerBlock("stripped_forest_deceiver_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG).mapColor(DyeColor.BLACK)));
    public static final RegistryObject<Block> STRIPPED_FOREST_DECEIVER_WOOD = registerBlock("stripped_forest_deceiver_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_WOOD).mapColor(DyeColor.BLACK)));
    public static final RegistryObject<Block> FOREST_DECEIVER_PLANKS = registerBlock("forest_deceiver_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).mapColor(DyeColor.BLACK)));
    public static final RegistryObject<Block> FOREST_DECEIVER_LEAVES = registerBlock("forest_deceiver_leaves",
            () -> new ModLeavesWeepingBlock(4, 6, 1, BlockBehaviour.Properties.copy(Blocks.BIRCH_LEAVES)));
    ...
    public static final RegistryObject<Block> FOREST_DECEIVER_STAIRS = registerBlock("forest_deceiver_stairs",
            () -> new StairBlock(() -> ModBlocks.FOREST_DECEIVER_PLANKS.get().defaultBlockState(),
                    BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS).mapColor(DyeColor.BLACK)));
    public static final RegistryObject<Block> FOREST_DECEIVER_SLAB = registerBlock("forest_deceiver_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SLAB).mapColor(DyeColor.BLACK)));

    public static final RegistryObject<Block> FOREST_DECEIVER_BUTTON = registerBlock("forest_deceiver_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON).mapColor(DyeColor.BLACK),
                    BlockSetType.OAK, 10, true));
    public static final RegistryObject<Block> FOREST_DECEIVER_PRESSURE_PLATE = registerBlock("forest_deceiver_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE).mapColor(DyeColor.BLACK),
                    BlockSetType.OAK));

    public static final RegistryObject<Block> FOREST_DECEIVER_FENCE = registerBlock("forest_deceiver_fence",
            () -> new FenceBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE).mapColor(DyeColor.BLACK)));
    public static final RegistryObject<Block> FOREST_DECEIVER_FENCE_GATE = registerBlock("forest_deceiver_fence_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE).mapColor(DyeColor.BLACK),
                    SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));

    public static final RegistryObject<Block> FOREST_DECEIVER_DOOR = registerBlock("forest_deceiver_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR).mapColor(DyeColor.BLACK),
                    BlockSetType.OAK));
    public static final RegistryObject<Block> FOREST_DECEIVER_TRAPDOOR = registerBlock("forest_deceiver_trapdoor",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR).mapColor(DyeColor.BLACK),
                    BlockSetType.OAK));
    ...
    public static final RegistryObject<Block> ARAUCARIA_PLANKS = registerBlock("araucaria_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS)));
    public static final RegistryObject<Block> ARAUCARIA_LEAVES = registerBlock("araucaria_leaves",
            () -> new ModLeavesBlock(2, 4, BlockBehaviour.Properties.copy(Blocks.JUNGLE_LEAVES)));
    ...
    public static final RegistryObject<Block> FOGGY_OAK_LEAVES = registerBlock("foggy_oak_leaves",
            () -> new ModLeavesBlock(6, 8, BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistryObject<Block> FOGGY_PINE_LOG = registerBlock("foggy_pine_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY)));
    public static final RegistryObject<Block> FOGGY_PINE_WOOD = registerBlock("foggy_pine_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.TERRACOTTA_LIGHT_GRAY)));
    ...
    public static final RegistryObject<Block> FOGGY_PINE_PLANKS = registerBlock("foggy_pine_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS)));
    public static final RegistryObject<Block> FOGGY_PINE_LEAVES = registerBlock("foggy_pine_leaves",
            () -> new ModLeavesBlock(5, 9, BlockBehaviour.Properties.copy(Blocks.BIRCH_LEAVES)));
    ...
    public static final RegistryObject<Block> STRIPPED_SWAMPY_POPLAR_LOG = registerBlock("stripped_swampy_poplar_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> STRIPPED_SWAMPY_POPLAR_WOOD = registerBlock("stripped_swampy_poplar_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_WOOD).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> SWAMPY_POPLAR_PLANKS = registerBlock("swampy_poplar_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> SWAMPY_POPLAR_LEAVES = registerBlock("swampy_poplar_leaves",
            () -> new ModLeavesBlock(4, 6, BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).mapColor(DyeColor.WHITE)));
    ...
    public static final RegistryObject<Block> SWAMPY_POPLAR_STAIRS = registerBlock("swampy_poplar_stairs",
            () -> new StairBlock(() -> ModBlocks.SWAMPY_POPLAR_PLANKS.get().defaultBlockState(),
                    BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> SWAMPY_POPLAR_SLAB = registerBlock("swampy_poplar_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SLAB).mapColor(DyeColor.WHITE)));

    public static final RegistryObject<Block> SWAMPY_POPLAR_BUTTON = registerBlock("swampy_poplar_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON).mapColor(DyeColor.WHITE),
                    BlockSetType.OAK, 10, true));
    public static final RegistryObject<Block> SWAMPY_POPLAR_PRESSURE_PLATE = registerBlock("swampy_poplar_pressure_plate",
            () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.OAK_PRESSURE_PLATE).mapColor(DyeColor.WHITE),
                    BlockSetType.OAK));

    public static final RegistryObject<Block> SWAMPY_POPLAR_FENCE = registerBlock("swampy_poplar_fence",
            () -> new FenceBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE).mapColor(DyeColor.WHITE)));
    public static final RegistryObject<Block> SWAMPY_POPLAR_FENCE_GATE = registerBlock("swampy_poplar_fence_gate",
            () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.OAK_FENCE_GATE).mapColor(DyeColor.WHITE),
                    SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));

    public static final RegistryObject<Block> SWAMPY_POPLAR_DOOR = registerBlock("swampy_poplar_door",
            () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_DOOR).mapColor(DyeColor.WHITE),
                    BlockSetType.OAK));
    public static final RegistryObject<Block> SWAMPY_POPLAR_TRAPDOOR = registerBlock("swampy_poplar_trapdoor",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.OAK_TRAPDOOR).mapColor(DyeColor.WHITE),
                    BlockSetType.OAK));
    ...
    public static final RegistryObject<Block> SNOWY_TREE_LEAVES = registerBlock("snowy_tree_leaves",
            () -> new ModLeavesBlock(1, 2, BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).mapColor(MapColor.TERRACOTTA_RED)));
    ...
    public static final RegistryObject<Block> PRICKLY_TREE_LEAVES = registerBlock("prickly_tree_leaves",
            () -> new ModLeavesBlock(8, 11, BlockBehaviour.Properties.copy(Blocks.SPRUCE_LEAVES)));
    ...
    public static final RegistryObject<Block> STONE_TREE_LOG = registerBlock("stone_tree_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.TERRACOTTA_CYAN)));
    public static final RegistryObject<Block> STONE_TREE_WOOD = registerBlock("stone_tree_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.TERRACOTTA_CYAN)));
    ...
    public static final RegistryObject<Block> STONE_TREE_LEAVES = registerBlock("stone_tree_leaves",
            () -> new ModLeavesBlock(1, 2, BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistryObject<Block> TROPIC_TREE_LOG = registerBlock("tropic_tree_log",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)));
    public static final RegistryObject<Block> TROPIC_TREE_WOOD = registerBlock("tropic_tree_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)));
    ...
    public static final RegistryObject<Block> TROPIC_TREE_PLANKS = registerBlock("tropic_tree_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS)));
    public static final RegistryObject<Block> TROPIC_TREE_LEAVES = registerBlock("tropic_tree_leaves",
            () -> new ModLeavesBlock(5, 7, BlockBehaviour.Properties.copy(Blocks.SPRUCE_LEAVES)));
    ...
    public static final RegistryObject<Block> WILLOW_WOOD = registerBlock("willow_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.GLOW_LICHEN)));
    ...
    public static final RegistryObject<Block> WILLOW_LEAVES = registerBlock("willow_leaves",
            () -> new ModLeavesWeepingBlock(3, 5, 4, BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).mapColor(MapColor.GLOW_LICHEN)));
    ...
    public static final RegistryObject<Block> RUBBER_TREE_PLANKS = registerBlock("rubber_tree_planks",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS)));
    public static final RegistryObject<Block> RUBBER_TREE_LEAVES = registerBlock("rubber_tree_leaves",
            () -> new ModLeavesBlock(6, 8, BlockBehaviour.Properties.copy(Blocks.ACACIA_LEAVES)));
    ...
    public static final RegistryObject<Block> RAW_NIOBIUM_BLOCK = registerBlock("raw_niobium_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.RAW_IRON_BLOCK).mapColor(DyeColor.LIGHT_BLUE)));

    // --------- / RAW / ORE BLOCKS / --------- //
    public static final RegistryObject<Block> SALT_BLOCK = registerBlock("salt_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK).strength(3.0F).explosionResistance(10.0F).mapColor(MapColor.QUARTZ)));
    public static final RegistryObject<Block> SULFUR_BLOCK = registerBlock("sulfur_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK).strength(5.0F).explosionResistance(10.0F).mapColor(MapColor.COLOR_YELLOW)));
    public static final RegistryObject<Block> NIOBIUM_BLOCK = registerBlock("niobium_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(5.0F).explosionResistance(10.0F).mapColor(DyeColor.LIGHT_BLUE)));
    public static final RegistryObject<Block> BIO_SHALE_BLOCK = registerBlock("bio_shale_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK).strength(5.0F).explosionResistance(10.0F).mapColor(DyeColor.LIME)));
    ...
    public static final RegistryObject<Block> CLEAN_FILTER_COAL_BLOCK = registerBlock("clean_filter_coal_block",
            () -> new CleanModFilterCoalBlock(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK), IPollutableBlock.PollutionState.CLEAN));
    public static final RegistryObject<Block> SLIGHTLY_POLLUTED_FILTER_COAL_BLOCK = registerBlock("slightly_polluted_filter_coal_block",
            () -> new SlightlyPollutedModFilterCoalBlock(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK), IPollutableBlock.PollutionState.CLEAN));
    public static final RegistryObject<Block> MODERATELY_POLLUTED_FILTER_COAL_BLOCK = registerBlock("moderately_polluted_filter_coal_block",
            () -> new ModeratelyPollutedModFilterCoalBlock(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK), IPollutableBlock.PollutionState.CLEAN));
    public static final RegistryObject<Block> VERY_POLLUTED_FILTER_COAL_BLOCK = registerBlock("very_polluted_filter_coal_block",
            () -> new CompletelyPollutedModFilterCoalBlock(BlockBehaviour.Properties.copy(Blocks.COAL_BLOCK), IPollutableBlock.PollutionState.CLEAN));
    ...
    public static final RegistryObject<Block> SOAP_BLOCK = registerBlock("soap_block",
            () -> new SoapBlock(BlockBehaviour.Properties.copy(Blocks.LIME_TERRACOTTA).friction(0.99F).strength(0.6F)));
    ...
    public static final RegistryObject<Block> FLOATING_MAT = registerBlock("floating_mat",
            () -> new FloatingMatBlock(BlockBehaviour.Properties.copy(Blocks.COBWEB).sound(SoundType.GRAVEL)));
    ...
    public static final RegistryObject<Block> FOGGY_SPONGE = registerBlock("foggy_sponge",
            () -> new FoggySpongeBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_MUSHROOM_BLOCK)
                    .mapColor(MapColor.TERRACOTTA_YELLOW).sound(SoundType.MOSS).noOcclusion()));
    ...
    public static final RegistryObject<Block> NIOBIUM_CHEST = BLOCKS.register("niobium_chest",
            () -> new ModChestBlock(ChestVariants.NIOBIUM_NORMAL, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_BLUE)
                    .strength(2.5F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> NIOBIUM_TRAPPED_CHEST = BLOCKS.register("niobium_trapped_chest",
            () -> new ModTrappedChestBlock(ChestVariants.NIOBIUM_TRAPPED, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_BLUE)
                    .strength(2.5F).sound(SoundType.METAL)));

    public static final RegistryObject<Block> FOGGY_STONE_FURNACE = registerBlock("foggy_stone_furnace",
            () -> new FoggyStoneFurnaceBlock(BlockBehaviour.Properties.copy(Blocks.STONE).strength(3.5F)));
    public static final RegistryObject<Block> CAMPFIRE = registerBlock("campfire",
            () -> new CampfireBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).strength(0.4F).mapColor(MapColor.NONE).noOcclusion()));
    public static final RegistryObject<Block> CERAMIC_URN = registerBlock("ceramic_urn",
            () -> new CeramicUrnBlock(BlockBehaviour.Properties.copy(Blocks.TERRACOTTA).noOcclusion()));
    public static final RegistryObject<Block> LATEX_POT = registerBlock("latex_pot",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.FLOWER_POT).noOcclusion()));
